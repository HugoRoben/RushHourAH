...
#         """
#         x, y = vehicle._x, self.size - 1 - vehicle._y
...
#         return all(0 <= new_x < self.size and self.grid[self.size - y - 1][new_x] is None for new_x in range(start, end))
